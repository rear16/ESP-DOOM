...
doom_boolean         turbodetected[MAXPLAYERS];
...
doom_boolean         longtics;               // cph's doom 1.91 longtics hack
doom_boolean         lowres_turn;            // low resolution turning for longtics
...
doom_boolean         testcontrols = false;    // Invoked by setup to test controls
...
static doom_boolean  gamekeydown[NUMKEYS]; 
static int      turnheld;		// for accelerative turning 
 
static doom_boolean  mousearray[MAX_MOUSE_BUTTONS + 1];
static doom_boolean *mousebuttons = &mousearray[1];  // allow [-1]
...
static doom_boolean  dclickstate;
static int      dclicks; 
static int      dclicktime2;
static doom_boolean  dclickstate2;
static int      dclicks2;
...
static doom_boolean  joyarray[MAX_JOY_BUTTONS + 1]; 
static doom_boolean *joybuttons = &joyarray[1];		// allow [-1] 
...
static doom_boolean WeaponSelectable(weapontype_t weapon)
{
...
{ 
    ...
    if (demo_p == NULL)
    {
        I_Error("No demo lump: %s", defdemoname);
    }
